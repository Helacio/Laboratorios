...
INSERT INTO BASICOS VALUES('U9560','Coste�o');
...
INSERT INTO ESTILOS VALUES('Simple', 'Se sirve en bandejas, platos y pocillos de cartón y servilletas de papel.');
INSERT INTO ESTILOS VALUES('Normal', 'se sirve en bandejas de madera, platos, vasos y pocillos de cerámica, y servilletas de algodón.');
...
INSERT INTO CampañasPublicitarias VALUES('2103003399', 'Dia de los amigos', 'Empiecen el día desde temprano', 1000, TO_DATE('2025-03-13', 'YYYY-MM-DD'), '8 dias', 'U9560');
...
/*  En la creación de la tabla ESTILOS definimos que la descripción no podía estar NULA,
    por eso nos da un error de integridad, se espera que haya un valor en la descripción.   */

INSERT INTO ESTILOS VALUES ('Simple', NULL);

/*  Se definió que el nombre del cliente era una cadena de longitud 20. El nombre que se
    intentó insertar tiene 30 caracteres por lo que terminará en un error de longitud   */
...
/*  El idAnuncio es una llave primaria, por lo que no se deberia permitir valores repetidos ni nulos.
    Aún así en este caso se pude volver a insertar la misma fila    */

INSERT INTO FISICOS VALUES('0987456123', 'Cra 7 # 163 - 11', '8x3 m');

/*  Como regla de negocio se definió que el presupuesto de una campaña no podia ser negativo, sin embargo
    al insertar el valor -1500, no hay nada que lo detenga y es permitida esa inserción   */

INSERT INTO CampañasPublicitarias VALUES('3158416060', 'Cumplea�os', 'Regalale un desayuno al cumplea�ero', -1500, TO_DATE('2025-04-19', 'YYYY-MM-DD'),'4 dias', 'Y1348');

/*  Como regla de negocio se definió que los estados de los anuncios pueden ser 'activo' o 'cancelado'.
...
ALTER TABLE CLIENTES
ADD CONSTRAINT CK_Tcorreo CHECK (correo LIKE '%@%' AND correo NOT LIKE '@%' AND correo NOT LIKE '%@');
...
/*  El idAnuncio es una llave primaria, por lo que no se deber�a permitir valores repetidos ni nulos.
    A�n as� en este caso se pude volver a insertar la misma fila    
